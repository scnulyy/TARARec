We downloaded LLaMA-2-7B from [here](https://drive.google.com/file/d/1teUwLm4BOqhngfCKKXE1tiMhJPf_FvRJ/view?usp=sharing)

We propose a two-stage tuning recommendation framework for knowledge enhancement leveraging GPT-4.
...
| Ours              | **70.52** | **72.18** | **74.46** | **64.67** | **66.78** | **69.64** |

Table 1. we shown the AUC results of the baseline models and our frameworks on movie and book scenarios.

For our detailed running environment see requirements.txt.

Make sure your GPU memory is 24G or more.
...
Second-Stage Training base on LLaMA-2-7B:
```
